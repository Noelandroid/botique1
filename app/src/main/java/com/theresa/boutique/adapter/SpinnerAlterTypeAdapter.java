...
public class SpinnerAlterTypeAdapter extends ArrayAdapter implements SpinnerAdapter {

    ArrayList<AlterItem> mList;

    public SpinnerAlterTypeAdapter(Context context, int resource, ArrayList<AlterItem> list){
