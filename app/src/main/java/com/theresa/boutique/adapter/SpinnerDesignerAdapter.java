...
public class SpinnerDesignerAdapter extends ArrayAdapter implements SpinnerAdapter {

    ArrayList<DesignerItem> mList;

    public SpinnerDesignerAdapter(Context context, int resource, ArrayList<DesignerItem> list){
