...
public class SpinnerPriorityAdapter extends ArrayAdapter implements SpinnerAdapter {

    ArrayList<PriorityItem> mList;

    public SpinnerPriorityAdapter(Context context, int resource, ArrayList<PriorityItem> list){
