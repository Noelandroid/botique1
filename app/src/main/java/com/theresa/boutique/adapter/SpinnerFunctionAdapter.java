...
public class SpinnerFunctionAdapter extends ArrayAdapter implements SpinnerAdapter {

    ArrayList<FunctionItem> mList;

    public SpinnerFunctionAdapter(Context context, int resource, ArrayList<FunctionItem> list){
